...
$query= "select*from article where status='incerto'";
$result= mysqli_query($conexao, $query) or die(mysqli_error());
...
if(isset($_GET['msg'])){
    ...
    switch($msg){
        ...
        <div id="erro" class="alert alert-success" role="alert">
            <p align="center">Texto aprovado!</p>
        </div>
        <?php
        break;
		...
		<div class="row">
			<div class="col-md-12">
				<table class="table">
					...
					<button type="button" class="btn btn-xs btn-success" data-toggle="modal" data-target="#exampleModal" data-whatever="<?php echo $rows['idArticle']; ?>">Aprovar</button>
  	...
  	<div class="modal-dialog" role="document">
  		<div class="modal-content">
  			...
  			<div class="modal-body">
  				<form method="post" action="acts/aprovarba.php" enctype="multipart/form-data">
...
$('#exampleModal').on('show.bs.modal', function (event) {
  ...
  var modal = $(this)
  modal.find('.modal-title').text('Aprovar texto: ' + recipient)
